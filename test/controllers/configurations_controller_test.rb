...
class ConfigurationsControllerTest < ActionController::TestCase
  ...
  test "should create configuration" do
    assert_difference('Configuration.count') do
      post :create, configuration: { color: @configuration.color, description: @configuration.description, double_sided: @configuration.double_sided, price: @configuration.price, size: @configuration.size }
    end
  ...
  test "should update configuration" do
    patch :update, id: @configuration, configuration: { color: @configuration.color, description: @configuration.description, double_sided: @configuration.double_sided, price: @configuration.price, size: @configuration.size }
    assert_redirected_to configuration_path(assigns(:configuration))
  end
