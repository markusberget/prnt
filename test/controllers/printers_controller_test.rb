...
class PrintersControllerTest < ActionController::TestCase
  ...
  test "should create printer" do
    assert_difference('Printer.count') do
      post :create, printer: { configuration_id: @printer.configuration_id, location: @printer.location, name: @printer.name, rating: @printer.rating }
    end
  ...
  test "should update printer" do
    patch :update, id: @printer, printer: { configuration_id: @printer.configuration_id, location: @printer.location, name: @printer.name, rating: @printer.rating }
    assert_redirected_to printer_path(assigns(:printer))
  end
